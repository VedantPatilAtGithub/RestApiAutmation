...
public class Endpoints {
    ...
    public static PostData  postData = new PostData("AG", "PATIL", 7, 7);
    ...
    public static Response postUsers(){
        RestAssured.baseURI = BASE_URL;
        RequestSpecification request = RestAssured.given().contentType(ContentType.JSON);
        Response response = request.body(postData).post(path);
        return response;
    }
    ...
    public static Response putUser(){
        RestAssured.baseURI = BASE_URL;
        RequestSpecification request = RestAssured.given().contentType(ContentType.JSON);
        Response response = request.body(jsonDataFile).put("users/1");
        return response;
    }
